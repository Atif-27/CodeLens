...
if ENV == "DEVELOPMENT":
    ...
    qdrantClient = QdrantClient(
        ...
        api_key=os.getenv("QDRANT_API_KEYP"),
        timeout=60.0 
    )
llm = ChatOpenAI(
    model="gpt-4o mini")
...
# def summarize_code_snippet(code:str):
#     SYSTEM_PROMPT="You are an expert AI assistant with deep knowledge of programming, software architecture, and modern development practices. Summarize the following code by explaining its purpose, functionality, structure, concepts, and technologies used, ensuring all key aspects are clearly covered."
