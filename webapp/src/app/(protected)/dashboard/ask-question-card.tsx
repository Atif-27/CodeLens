...
const AskQuestionCard = () => {
  ...
  return (
    <Card className="group relative w-full overflow-hidden border-border bg-gradient-to-br from-primary/5 via-background to-background shadow-lg transition-all duration-300 hover:shadow-xl">
      ...
      <CardContent className="relative p-6">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-3">
          ...
          <Button 
            ...
            className="group/btn w-full transition-all duration-200"
            size="lg"
          >
